...
export const Home = () => {
    ...
    return(
        <div className="h-screen place-items-center  bg-gradient-to-r from-indigo-800 to-pink-400 via-purple-800 ">
            ...
            type="button" 
            class="text-white h-20 w-72 justify-self-auto bg-purple-300 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg px-5 py-2.5 mb-20 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none font-black text-2xl dark:focus:ring-blue-800">MINT NOW</button>
